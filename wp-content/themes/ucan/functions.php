...
function twentytwelve_setup() {
    ...
    set_post_thumbnail_size(628, 9999); // Unlimited height, soft crop
}
    ...
    function twentytwelve_content_nav($html_id) {
        ...
        if ($wp_query->max_num_pages > 1) :
            ...
            <nav id="<?php echo $html_id; ?>" class="navigation" role="navigation">
                <div class="nav-previous alignleft"><?php next_posts_link(__('<span class="meta-nav">&larr;</span> Bài cũ hơn', 'twentytwelve')); ?></div>
                <div class="nav-next alignright"><?php previous_posts_link(__('Bài mới hơn <span class="meta-nav">&rarr;</span>', 'twentytwelve')); ?></div>
    ...
    if (!function_exists('twentytwelve_entry_meta')) :
        ...
        function twentytwelve_entry_meta() {
            ...
            if ($tag_list) {
                ...
                $utility_text = __('Chuyên mục: %3$s', 'twentytwelve');
            }
