...
function comment_form($args = array(), $post_id = null) {
    ...
    $fields = array(
        'author' => '<p class="comment-form-author">' . '<label for="author">' . __('Họ tên') . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' .
    ...
    $required_text = sprintf(' ' . __('Những trường có dấu %s là bắt buộc'), '<span class="required">*</span>');
    $defaults = array(
        ...
        'comment_notes_before' => '<p class="comment-notes">' . __('Email của bạn sẽ được giữ kín.') . ( $req ? $required_text : '' ) . '</p>',
        'comment_notes_after' => '<p class="form-allowed-tags">' . sprintf(__('Bạn có thể sử dụng những thẻ HTML sau đây:  %s'), ' <code>' . allowed_tags() . '</code>') . '</p>',
        'id_form' => 'commentform',
        'id_submit' => 'submit',
        'title_reply' => __('Bình luận bài viết'),
    ...
    ?>
        ...
        <div id="respond">
            ...
            <?php echo $args['comment_notes_after']; ?>
                    <p class="form-submit">
                        <input class="frontend-blue-button" name="submit" type="submit" id="<?php echo esc_attr($args['id_submit']); ?>" value="<?php echo esc_attr($args['label_submit']); ?>" />
